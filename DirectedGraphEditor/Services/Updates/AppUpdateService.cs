...
using DirectedGraphEditor.Desktop;
using DirectedGraphEditor.Services.Data;
using DirectedGraphEditor.Services.Updates.Model;

namespace DirectedGraphEditor.Services.Updates;
        ...
        using (var httpClient = new HttpClient())
        {
            while (true)
            {
                try
                {
                    ...
                    {
                        RequestUri = new Uri("https://api.github.com/repos/chkr1011/DirectedGraphEditor/releases")
                    };

                    request.Headers.UserAgent.ParseAdd("DirectedGraphEditor");
